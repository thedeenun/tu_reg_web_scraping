...
book = load_workbook('Fact.xlsx')
writer = pd.ExcelWriter('Fact.xlsx', engine='openpyxl')
writer.book = book
...
df.to_excel(writer, sheet_name='เวลาที่เปิดสอนDimension', encoding='utf-8-sig', index=False)
writer.save()
writer.close()